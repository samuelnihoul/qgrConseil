    ...
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-8 pr--95">
        <div className="job-description mb-30">
          <p><strong>Job Description:</strong> A UI/UX (User Interface/User Experience) designer is responsible for designing and creating engaging and effective interfaces for software and web applications. This includes designing the layout, visual design, and interactivity of the user interface.</p>
        </div>
        <div className="job-responsibility mb-30">
          <p><strong>Job Responsibility:</strong> Collaborating with cross-functional teams: UI/UX designers often work closely with other teams, including product management, engineering, and marketing, to ensure that the user interface is aligned with business and technical requirements. You will need to be able to effectively communicate your design ideas and gather feedback from other team members.</p>
          <ul>
        ...
        <div className="job-responsibility mb-130">
          ...
          <ul>
            ...
            <li>Two more publication published in international journal.</li>
          </ul>
        </div>
                  ...
                  <div className="upload-file-area">
                    ...
                    <div className="custom-upload-field">
                      <div className="upload-pdf-icon">
                        <img src="/assets/img/inner-pages/upload-pdf-icon.svg" alt="" />
                      </div>
                ...
                <div className="col-lg-12">
                  <div className="form-inner">
                    <button className="primary-btn1 btn-hover" type="submit">
                      ...
                      <span style={{top: '60.5781px', left: '31.5938px'}} />
                    </button>
                  </div>
                </div>
              </div>
      ...
      <div className="col-lg-4">
        <div className="job-summary-area">
          <ul>
            <li><span className="title">Job Posted:</span><span> 02 February, 2023.</span></li>
            <li><span className="title">Vacancy:</span> 07 Person</li>
            <li><span className="title">Experiences:</span> 2-3 Years.</li>
            <li><span className="title">Education:</span> Phd Completed.</li>
            <li><span className="title">Gender:</span> Male/Female</li>
            <li><span className="title">Deadline:</span> 02/12/2023</li>
          </ul>
        </div>
      </div>
    </div>
...
export default PpplyPositionPage
