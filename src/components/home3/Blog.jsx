          ...
          <div className="col-lg-12">
            <div className="row g-4">
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="blog-card2 two">
                  <div className="blog-img magnetic-item">
                    <img src="assets/img/home3/blog-img-01.png" alt="" />
                  </div>
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="blog-card2 two">
                  <div className="blog-img magnetic-item">
                    <img src="assets/img/home3/blog-img-02.png" alt="" />
                  </div>
                  <div className="blog-content">
                    <ul className="tags">
                      <li>
                    ...
                    <h4>
                      <Link legacyBehavior href="/blog-details">
                        <a>A Booming Industry in Entrepreneurship</a>
                      </Link>
                    </h4>
                    <Link legacyBehavior href="/blog-details">
                      <a className="explore-btn">
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="blog-card2 two">
                  <div className="blog-img magnetic-item">
                    <img src="assets/img/home3/blog-img-03.png" alt="" />
                  </div>
                  <div className="blog-content">
                    <ul className="tags">
                      <li>
                    ...
                    <h4>
                      <Link legacyBehavior href="/blog-details">
                        <a>How Consulting Firms Are Embracing Innovation.</a>
                      </Link>
                    </h4>
                    <Link legacyBehavior href="/blog-details">
                      <a className="explore-btn">
              ...
              <div className="col-xl-3 col-lg-4 col-sm-6">
                <div className="blog-card2 two">
                  <div className="blog-img magnetic-item">
                    <img src="assets/img/home3/blog-img-04.png" alt="" />
                  </div>
                  <div className="blog-content">
                    <ul className="tags">
                      <li>
