...
const HorizontalScroll = () => {
  return (
    ...
    <div className="single-scroll-container three" style={{backgroundImage: 'linear-gradient(180deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.25) 100%), url(assets/img/home5/event-img.jpg)'}}>
