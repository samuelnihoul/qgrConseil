...
const Blog = () => {
  return (
    <div className="blog-section4 mb-130">
  <div className="container-fluid one pl--95">
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-5">
        <div className="section-title1 two mb-50">
          <span>News &amp; Insight</span>
          <h2>Staying informed about the latest news and insights in the field of business.</h2>
        ...
        <div className="row g-4">
          <div className="col-md-6">
            <div className="blog-card4">
              <div className="blog-flip-box-layer blog-card-front">
                <div className="blog-img">
                  <img src="assets/img/home4/blog-img-02.jpg" alt="" />
                </div>
                <div className="blog-content">
                  <div className="blog-content">
                    ...
                    <div className="title-and-btn">
                      <h4><Link legacyBehavior href="/blog-details"><a>Consulting Industry Adapts to the Changing Business Landscape.</a></Link></h4>  
              ...
              <div className="blog-flip-box-layer blog-card-back">
                <div className="blog-content">
                  <div className="blog-content">
                    <ul className="tags">
                      <li>
          ...
          <div className="col-md-6">
            <div className="blog-card4">
              <div className="blog-flip-box-layer blog-card-front">
                <div className="blog-img">
                  <img src="assets/img/home4/blog-img-01.jpg" alt="" />
                </div>
                <div className="blog-content">
                  <div className="blog-content">
                    <ul className="tags">
          ...
          <div className="col-md-6">
            <div className="blog-card4">
              <div className="blog-flip-box-layer blog-card-front">
                <div className="blog-img">
                  <img src="assets/img/home4/blog-img-03.jpg" alt="" />
                </div>
                <div className="blog-content">
                  <div className="blog-content">
                    <ul className="tags">
